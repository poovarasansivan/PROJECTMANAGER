                        ...
                        <div class="p-4 code-to-copy">
                            <div id="tableExample3"
                                ...
                                <div class="d-flex align-items-center justify-content-end">
                                    <div class="card shadow-none my-1" data-component-card="data-component-card">

                                        <div class="card-body p-1">
                                            <button class="btn btn-phoenix-success btn-sm" type="button"
                                                onclick="checkIn()" id="checkIn">Check IN</button>
                                            <a href="api/download.php">
                                                <button class="btn btn-phoenix-success btn-sm" type="button"
                                ...
                                <div id="work_log"
                                    data-list='{"valueNames":["userid","name","checkIn","checkOut","status"],"page":10,"pagination":true}'>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Student Worklog</h5>
                                                <button class="btn p-1" type="button" data-bs-dismiss="modal"
                                                    aria-label="Close"><span class="fas fa-times fs--1"></span></button>
                                            </div>
                                            <div class="modal-body">
                                                <div class="col-12 gy-6">
                                                    <label class="form-label" for="basic-form-textarea">CheckOut
                                                        Description</label>
                                                ...
                                                <div class="col-sm-6 col-md-12">
                                                    <div class="form-floating" style="margin-top:10px">
                                                        <select id="projectTitle" class="form-select"
                                                            id="floatingSelectAssignees">
                                                            <option selected="selected" disabled>Select projectTitle
                                                            </option>
                                                        </select><label for="floatingSelectAssignees">projectTitle
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="modal-footer"><button class="btn btn-primary" type="button"
                                                    onclick="submit()">Submit</button><button
                            ...
                            <div class="modal-body p-5 px-md-6">
                                <div class="row g-12">
                                    <div class="col-12 col-md-12">
                                        <div class="mb-4">
                                            <h1 id="name" class="me-3" style="font-size:15px;margin-bottom:10px">Name:
                                                POOVARASAN</h1>
                                            <h1 id="rollno" class="me-3" style="font-size:15px;">Roll No:7376211CS239
                                            </h1 style="">
                                        </div>
                                        <div class="mb-6">
                                            ...
                                            <h1 class="me-3" style="font-size:15px;margin-bottom:10px">Check IN Time:
                                            </h1>
                                            <p id="checkin"></p>
                                        ...
                                        <div class="modal-footer"><button class="btn btn-primary" type="button"
                                                id="approve" onclick="approve('1')">Approve</button><button
                                                class="btn btn-outline-primary" type="button" onclick="approve('2')"
                                                id="reject" data-bs-dismiss="modal">Reject</button></div>
                                    </div>
                                </div>
